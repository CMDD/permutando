        ...
        <div class="row">
            ...
            <div class="col-md-5 p-3">
                <div class="caja p-4">
                    ...
                    <div class="form-group">
                        <label>Balcón</label>
                        <div class="my-radio">
                          <input type="radio" id="balcon_1" name="balcon" />
                          <label for="balcon_1">Si</label>
                          <input type="radio" id="balcon_0" name="balcon"  />
                    ...
                    <div class="form-group">
                        <label>Terraza</label>
                        <div class="my-radio">
                          <input type="radio" id="terraza_1" name="terraza" />
                          <label for="terraza_1">Si</label>
                          <input type="radio" id="terraza_0" name="terraza"  />
                    ...
                    <div class="form-group">
                        ...
                        <div class="my-radio">
                          <input type="radio" id="parqueadero_1" name="parqueadero" />
                          <label for="parqueadero_1">Si</label>
                          <input type="radio" id="parqueadero_0" name="parqueadero"  />
                    ...
                    <div class="form-group">
                        ...
                        <div class="my-radio">
                          <input type="radio" id="porteria_1" name="porteria" />
                          <label for="porteria_1">Si</label>
                          <input type="radio" id="porteria_0" name="porteria"  />
            ...
            <div class="col-md-7 p-3">
                <div class="caja p-4">
                    <div class="edit-gallery">
                        ...
                        <div class="image added">
                            ...
                            <input type="file" id="file_1" class="inputfile" disabled />
                            <label for="file_1" style="background-image: url(http://permutando.test/img/pc.png);"></label>
                        </div>
                        <div class="image added">
                            <span class="delete">&times;</span>
                            <input type="file" id="file_2" class="inputfile" disabled />
                            <label for="file_2" style="background-image: url(http://permutando.test/img/pc.png);"></label>
                        </div>
                        <div class="image added">
                            <span class="delete">&times;</span>
                            <input type="file" id="file_3" class="inputfile" disabled />
                            <label for="file_3" style="background-image: url(http://permutando.test/img/pc.png);"></label>
                        </div>
                        <div class="image">
                            <span class="delete">&times;</span>
                        ...
                        <div class="image added">
                            ...
                            <label for="file_5" style="background-image: url(http://permutando.test/img/pc.png);"></label>
                        </div>
                        <div class="image">
                            <span class="delete">&times;</span>
                ...
                <div class="caja p-4 mt-4">
                    <div class="row my-checkbox">
                        <div class="col-md-3">
                            <label>Zonas Comunes</label>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" value="Gimnasio" id="zonas_1"> <label for="zonas_1">Gimnasio</label>
                            <input type="checkbox" value="BBQ" id="zonas_2"> <label for="zonas_2">BBQ</label>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" value="Salón comunal" id="zonas_3"> <label for="zonas_3">Salón comunal</label>
                            <input type="checkbox" value="Zona húmeda" id="zonas_4"> <label for="zonas_4">Zona húmeda</label>
                        </div>
                        <div class="col-md-3">
                            <input type="checkbox" value="Parques para niños" id="zonas_5"> <label for="zonas_5">Parques para niños</label>
                        </div>
                    </div>
                    <div class="row">
        ...
        $(".inputfile").change(function() {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    $(input).parent().addClass('added');
                    $(input).prop('disabled', true);
                }
                reader.readAsDataURL(input.files[0]);
            } else {
                $(input).parent().removeClass('added');
